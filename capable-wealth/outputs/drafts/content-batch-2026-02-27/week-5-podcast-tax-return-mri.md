...
Thanks for spending this time with me today. Talk to you next week.
...
### Voice Alignment
- [x] Opens with a specific, conversational scenario (challenges the assumption that the CPA's "all clear" means everything is optimized)
- [x] Contains at least one contrarian reframe or myth-bust (your tax return is a diagnostic report, not a compliance document; "maxed out" retirement contributions is misleading)
- [x] Uses direct "you" address throughout
- [x] Reads like a conversation with a trusted advisor, not a lecture or sales piece
- [x] Avoids all banned language from brand standards (no em dashes, no formulaic "not X / it's Y" pivot constructions)
- [x] Ends with a clear takeaway and appropriate sign-off (philosophical close with clinical parallel)
...
- [x] More depth and nuance than the blog version (extended case study, segment-by-segment diagnostic walkthrough, full treatment plan, personal reflection)

### Audience Specificity
- [x] Could only have been written for orthopedic surgeons (MRI diagnostic metaphor, meniscal tear references, ACL analogy, residency teaching framing, OR time, S-Corp practice structure)
- [x] Includes concrete numerical examples relevant to surgeon-level income ($820K AGI, $298K total tax, $203K retirement capacity, $172K contribution gap, $52K state tax)
- [x] References practice-specific context throughout (S-Corp salary calibration, cash balance plans, QBI for medical practices, locum work, practice transitions)
- [x] Respects the listener's intelligence and time (no unnecessary explanation of clinical concepts, trusts familiarity with diagnostic frameworks)
- [x] Surgical metaphors and clinical thinking patterns woven naturally (MRI findings, diagnostic markers, normal ranges, concerning findings, treatment plans)
...
- [x] 2026 retirement contribution limits referenced accurately ($24,500 + $8,000 catch-up + $11,250 super catch-up; $72,000 DC limit; $150K-$350K+ cash balance)

### Pull Signal Design
- [x] Content provides genuine value that a surgeon would share with a colleague or practice partner
- [x] Ties tactical advice back to a bigger life principle (diagnostic rigor, the skill transfer from clinical to financial, agency over outcomes)
- [x] Includes a natural next step that deepens the relationship (bring four numbers to your financial advisor)
- [x] The listener finishes feeling more informed and more in control, not more anxious
- [x] Actionable takeaway is specific and achievable within one week (pull four numbers from your tax return in 15 minutes)

### Visual Assets
- [x] Every content piece includes a Visual Asset Brief in the standard draft file format
- [x] Image type is appropriate for the platform and content (podcast cover art 1400x1400, YouTube thumbnail variant 1280x720)
- [x] AI image prompt follows the full 9-point standard: canvas, background, layout, typography, graphic elements, photographic direction, brand constraints, mood, audience context
