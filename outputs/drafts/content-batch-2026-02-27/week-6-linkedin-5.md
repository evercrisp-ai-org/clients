# Every Quarter, Four Numbers Tell You Whether Your Financial Plan Is on Track. Most Surgeons Check Zero of Them.
...
Which of these four have you looked at this quarter?
...
### Voice Alignment
- [x] Opens with a story, conversation, or specific scenario (draws a parallel between clinical vital signs and financial vital signs)
- [x] Contains at least one contrarian reframe or myth-bust (challenges the assumption that annual reviews are sufficient, advocates quarterly cadence)
...
- [x] Ends with a clear takeaway and appropriate sign-off (self-assessment question, no sign-off per LinkedIn format)
...
- [x] Could only have been written for orthopedic surgeons (clinical vital signs analogy, CMS efficiency adjustment, practice overhead reserves, surgeon-level contribution limits)
- [x] Includes a concrete numerical example relevant to surgeon-level income ($24,500 401(k), $8,125 Q1 pace with catch-up, $200,000 cash balance, $50,000 Q1 target)
- [x] References practice-specific context where appropriate (practice revenue, CMS adjustment, practice overhead reserves, equipment purchases)
- [x] Respects the reader's intelligence and time (actionable framework with specific benchmarks, no unnecessary explanation)
...
- [x] Ties tactical advice back to a bigger life principle (proactive monitoring, the discipline of consistent review, control through awareness)
- [x] Includes a natural next step that deepens the relationship (prompts immediate quarterly review, saveable framework)
...
- [x] Image type is appropriate for the platform and content (conceptual photograph, environment, LinkedIn 1080x1080)
