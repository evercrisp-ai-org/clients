...
- **Platform and dimensions:** Podcast cover 1400x1400, YouTube thumbnail variant 1280x720
...
### Voice Alignment
- [x] Opens with a story, conversation, or specific scenario (direct hook about the gap between collections knowledge and effective hourly rate knowledge)
- [x] Contains at least one contrarian reframe or myth-bust (collections as a "vanity metric" for the surgeon, reframing overhead optimization as recovering hours of life)
...
- [x] Ends with a clear takeaway and appropriate sign-off (philosophical close on measurement and truth, "Capably yours")
...
- [x] Conversational, exploratory tone appropriate for podcast format (Jared thinking out loud with the listener)
- [x] More depth and nuance than blog format

### Audience Specificity
- [x] Could only have been written for orthopedic surgeons (not generic financial advice)
- [x] Includes concrete numerical examples relevant to surgeon-level income ($2.4M collections, $480K take-home, $185/hr effective rate, $78K annual improvement)
- [x] References practice-specific context where appropriate (OR time, clinical hours, CMS reimbursement, practice overhead, case volume)
...
- [x] Ties tactical advice back to a bigger life principle (measurement, precision, truth, time as the ultimate asset)
- [x] Includes a natural next step that deepens the relationship (calculate the number, then have the conversation about what to do about it)
- [x] The listener finishes feeling more informed and more in control, not more anxious

### Arc Continuity
- [x] References Week 1 (entity structure, three structural gaps, $85K-$130K annual leakage)
- [x] References Week 2 (S-Corp salary calibration, three-variable balancing act)
- [x] References Week 3 (CMS reimbursement cut, overhead optimization, volume vs. structure response)
- [x] Synthesizes all three weeks into the capstone metric (effective hourly rate)
- [x] Functions as a satisfying conclusion to the March "diagnosis" arc

### Visual Assets
- [x] Every content piece includes a Visual Asset Brief in the standard draft file format
- [x] Image type is appropriate for the platform and content (Podcast cover 1400x1400, YouTube thumbnail variant 1280x720)
...
- [x] Segment 1: ~4 minutes
- [x] Segment 2: ~5 minutes
- [x] Segment 3: ~4.5 minutes
- [x] Segment 4: ~5 minutes
- [x] Segment 5: ~3.5 minutes
