# Q1 Revenue Is In. Ask About Your Keep Rate Before Anything Else.

## Post Metadata
- **Type:** LinkedIn Post
- **Week:** Week 4 (March 23–29)
- **Theme:** The Number That Matters More Than Collections
- **Quarterly plan reference:** quarterly-plan-Q2-2026.md, Week 4, LinkedIn 2
- **Strategic context:** Ties the effective hourly rate concept to the Q1 close, making the post timely and actionable. Introduces "keep rate" as a digestible metric surgeons can track quarterly. Positions revenue growth without structural improvement as a warning sign, not a celebration.
...
Q1 revenue data is in. Before you celebrate (or panic), ask this: did your keep rate go up or down?
...
One number. One question. That's your Q1 financial check-up.
...
- [x] Includes a concrete numerical example relevant to surgeon-level income ($600K quarterly, 20% keep rate)
- [x] References practice-specific context where appropriate (overhead creep, marginal brackets, retirement plans)
...
- [x] Content is appropriately timed relative to the annual calendar (Q1 close, late March)
